      ...
      <div className="container-brand relative z-10">
        <div className="max-w-[var(--content-mid)] mx-auto text-center">
          ...
          <MotionWrapper delay={0.5}>
            <div className="flex flex-col sm:flex-row items-center justify-center divide-y sm:divide-y-0 sm:divide-x divide-[var(--gold-mid)]/20">
              {[
                ...
                <div
                  key={item.label}
                  className="flex flex-col items-center gap-2 px-10 py-5 w-full sm:w-auto"
                >
