            ...
            <MotionWrapper delay={0.42}>
              <div className="flex flex-col gap-5">
                ...
                <Link
                  ...
                  className="flex items-center gap-4 group"
                >
                  <div className="w-10 h-10 border border-[var(--brand-wa)]/30 flex items-center justify-center group-hover:border-[var(--brand-wa)] transition-colors">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="var(--brand-wa)" aria-hidden="true">
