        ...
        <div className="max-w-[var(--content-mid)] mx-auto text-center">
          ...
          <MotionWrapper delay={0.42}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              <Link href="/contact" className="btn btn-dark w-full sm:w-auto">
                Inquire Now
              </Link>
              ...
              <Link
                ...
                className="btn flex items-center justify-center gap-3 w-full sm:w-auto border border-[var(--brand-wa)]/40 text-[var(--brand-wa)] hover:bg-[var(--brand-wa)]/10"
              >
