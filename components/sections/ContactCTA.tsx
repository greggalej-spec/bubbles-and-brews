          ...
          <MotionWrapper delay={0.42}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              ...
              <Link
                ...
                className="flex items-center justify-center gap-3 px-10 py-4 border border-[#25D366]/40 text-[#22a852] text-sm tracking-widest uppercase hover:bg-[#25D366]/10 transition-all duration-300 w-full sm:w-auto"
              >
