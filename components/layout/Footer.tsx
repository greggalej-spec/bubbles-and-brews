        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-4 inline-flex items-center gap-2 px-5 py-2.5 bg-[var(--brand-wa)]/10 border border-[var(--brand-wa)]/30 text-[var(--brand-wa)] text-sm tracking-wide hover:bg-[var(--brand-wa)]/20 transition-all duration-300 w-fit"
            >
